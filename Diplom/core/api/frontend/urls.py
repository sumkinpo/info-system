...
urlpatterns = [
    ...
    url(r'^entity/(?P<pk>\d+)/(?P<operation>\w+)/$', EntityOperation.as_view(), name='author-operation'),
    ...
    url(r'^image/(?P<pk>\d+)/(?P<operation>\w+)/$', ImageOperation.as_view(), name='author-operation'),
    url(r'^image-operation/$', ImageView.as_view(), name='author-add'),
    url(r'^image-operation/(?P<pk>\d+)/$', ImageView.as_view(), name='author-change'),
